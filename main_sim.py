...
def init_params(term_admin_laiv = "term_1"):
    ...
    scenarios = {
        ...
        "B": ["pessimistic", ["5-11"], [0.2], "pessimistic 20% 5-12", "Pessimistic_cover20_LAIV_5-12yo"], 
        "C": ["pessimistic", ["5-11"], [0.4], "pessimistic 40% 5-12", "Pessimistic_cover40_LAIV_5-12yo"], 
        "D": ["pessimistic", ["5-11"], [0.6], "pessimistic 60% 5-12", "Pessimistic_cover60_LAIV_5-12yo"], 
        "E": ["pessimistic", ["5-11"], [0.8], "pessimistic 80% 5-12", "Pessimistic_cover80_LAIV_5-12yo"], 
        "F": ["central", ["5-11"], [0.2], "central 20% 5-12", "Central_cover20_LAIV_5-12yo"], 
        "G": ["central", ["5-11"], [0.4], "central 40% 5-12", "Central_cover40_LAIV_5-12yo"], 
        "H": ["central", ["5-11"], [0.6], "central 60% 5-12", "Central_cover60_LAIV_5-12yo"], 
        "I": ["central", ["5-11"], [0.8], "central 80% 5-12", "Central_cover80_LAIV_5-12yo"], 
        "J": ["optimistic", ["5-11"], [0.2], "optimistic 20% 5-12", "Optimistic_cover20_LAIV_5-12yo"], 
        "K": ["optimistic", ["5-11"], [0.4], "optimistic 40% 5-12", "Optimistic_cover40_LAIV_5-12yo"], 
        "L": ["optimistic", ["5-11"], [0.6], "optimistic 60% 5-12", "Optimistic_cover60_LAIV_5-12yo"], 
        "M": ["optimistic", ["5-11"], [0.8], "optimistic 80% 5-12", "Optimistic_cover80_LAIV_5-12yo"], 
        "N": ["pessimistic", ["5-11", "12-17"], [0.2, 0.2], "pessimistic 20% 5-18", "Pessimistic_cover20_LAIV_5-18yo"], 
        "O": ["pessimistic", ["5-11", "12-17"], [0.4, 0.4], "pessimistic 40% 5-18", "Pessimistic_cover40_LAIV_5-18yo"], 
        "P": ["pessimistic", ["5-11", "12-17"], [0.6, 0.6], "pessimistic 60% 5-18", "Pessimistic_cover60_LAIV_5-18yo"], 
        "Q": ["pessimistic", ["5-11", "12-17"], [0.8, 0.8], "pessimistic 80% 5-18", "Pessimistic_cover80_LAIV_5-18yo"], 
        "R": ["central", ["5-11", "12-17"], [0.2, 0.2], "central 20% 5-18", "Central_cover20_LAIV_5-18yo"], 
        "S": ["central", ["5-11", "12-17"], [0.4, 0.4], "central 40% 5-18", "Central_cover40_LAIV_5-18yo"], 
        "T": ["central", ["5-11", "12-17"], [0.6, 0.6], "central 60% 5-18", "Central_cover60_LAIV_5-18yo"], 
        "U": ["central", ["5-11", "12-17"], [0.8, 0.8], "central 80% 5-18", "Central_cover80_LAIV_5-18yo"], 
        "V": ["optimistic", ["5-11", "12-17"], [0.2, 0.2], "optimistic 20% 5-18", "Optimistic_cover20_LAIV_5-18yo"], 
        "W": ["optimistic", ["5-11", "12-17"], [0.4, 0.4], "optimistic 40% 5-18", "Optimistic_cover40_LAIV_5-18yo"], 
        "X": ["optimistic", ["5-11", "12-17"], [0.6, 0.6], "optimistic 60% 5-18", "Optimistic_cover60_LAIV_5-18yo"], 
        "Y": ["optimistic", ["5-11", "12-17"], [0.8, 0.8], "optimistic 80% 5-18", "Optimistic_cover80_LAIV_5-18yo"]
        # "Z": ["central", ["2-4"], [0.4], "central 40% 2-5", "Central_cover40_LAIV_2-5yo"], 
